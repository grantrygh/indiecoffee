...
class Menu extends Component {
	...
	state = {
		...
		sandwiches : [
			...
			// On a Bagel
			{name:"Fancy Grilled Cheese", price: "4.66", desc:"Not one, not two, but three cheeses melt into deliciousness. Toasted NY sun-dried tomato bagel, cream cheese, goat cheese, tomato, olive oil and basil topped with melted provolone."},
			{name:"Marathon", price: "4.66", desc:"Toasted NY whole wheat bagel, Danish havarti cheese, roasted red pepper and spinach. So healthy you'll feel like running a marathon!"},
			{name:"Egg Double Cheese", price: "4.66", desc:"Omelet, cream cheese, and cheddar on the NY bagel of your choice."},
			{name:"Greenbush", price: "4.66", desc:"Toasted NY everything bagel, cream cheese, oregano, tomato, olive oil and market ham. A salute to our neighborhood!"},
			{name:"Bacon, Egg and Cheddar", price: "4.66", desc:"Ah, bacon!  On the NY bagel of your choice."},
			// On Focaccia
